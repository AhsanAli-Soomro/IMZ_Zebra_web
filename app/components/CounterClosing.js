...
export default function CounterClosing() {
  ...
  return (
    <div className="p-2 md:p-6 space-y-6 text-gray-800">
      <div>
        <h1 className="text-2xl font-bold">Galla / Counter Closing</h1>
      ...
      <form onSubmit={submit} className="bg-white border rounded-2xl shadow-sm p-5 space-y-4">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <label className="text-sm font-medium">Physical Cash in Galla (PKR)
      ...
      <section className="bg-white border rounded-2xl shadow-sm overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading ? <tr><td colSpan="8" className="p-8 text-center text-gray-500">Loading closing history...</td></tr> : rows.length === 0 ? <tr><td colSpan="8" className="p-8 text-center text-gray-500">No Galla closing found for these filters.</td></tr> : rows.map((row) => {
