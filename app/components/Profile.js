      ...
      <div className="md:col-span-1 flex justify-center">
        {form.existing_logo ? (
          <img
            ...
            alt="Company Logo"
            className="h-32 w-32 object-contain border border-gray-300 rounded-lg shadow-sm bg-white"
          />
        ) : (
    ...
    >
      ...
      {[
        ...
        <div key={key}>
          ...
          <input
            className="w-full border border-gray-300 p-2 rounded focus:ring-indigo-500 focus:border-indigo-500 shadow-sm"
            value={form[key]}
